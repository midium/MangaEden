...
#Region "Work functions"
    ...
    Private Function CreateChapterZIP()
        Dim destinationFile As String = String.Format("{0}\{1}", _zipDestinationFolder, String.Format("{0}_-_{1}_-_{2}.zip", _mangaTitle, _chapterNumber, If(_chapterTitle IsNot Nothing, _chapterTitle.Replace(" ", "_").Replace("?", "").Replace("/", "-").Replace("\", "-").Replace(":", "").Replace("""", ""), "")))
